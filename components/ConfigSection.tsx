                        ...
                        <div className="grid grid-cols-2 gap-2 h-64 overflow-y-auto custom-scrollbar pr-1 content-start">
                            ...
                            {hasReferenceImage && (
                                <button
                                    ...
                                    className={`p-3 rounded-lg border text-xs font-bold text-left transition-all flex items-center gap-2 ${
                                        tempEmotion === SAME_AS_REF_ID 
