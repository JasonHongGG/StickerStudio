...
import { ArrowLeft, Upload, X, Download, Check, Image as ImageIcon, Trash2, ArrowRight, Plus, Scan, Lock, Archive } from 'lucide-react';
            ...
            <div className="w-full lg:w-80 flex-shrink-0 border-r border-gray-100 bg-white flex flex-col z-10 font-sans">
                ...
                <div className="flex-shrink-0 p-5 border-b border-gray-100 bg-white z-20">
                    ...
                    <div
                        ...
                        className={`
                            ...
                            ${isDragOver ? 'border-black bg-gray-50' : 'border-gray-300 hover:border-black hover:bg-gray-50'}
                        `}
                    >
                        <input
                            type="file"
                        ...
                        <div className="relative z-10 flex flex-col items-center gap-2">
                            <div className={`p-2 rounded-full transition-colors ${isDragOver ? 'bg-black text-white' : 'bg-gray-100 text-gray-600 group-hover:bg-black group-hover:text-white'}`}>
                                <Upload size={18} />
                            </div>
                ...
                <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent flex flex-col">
                    ...
                    <div className="p-5 border-b border-gray-100 flex gap-3">
                        <div className="flex-1">
                            ...
                            <input
                                ...
                                className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-sm font-bold text-gray-900 focus:outline-none focus:border-black transition-colors"
                            />
                        </div>
                        <div className="flex-1">
                    ...
                    <div className="p-3 space-y-2 flex-1">
                        ...
                        {images.length === 0 && (
                            <div className="h-full min-h-[100px] flex flex-col items-center justify-center text-gray-300 gap-2 opacity-60">
                                <ImageIcon size={32} />
                    ...
                    {selectedImage ? (
                        <>
                            ...
                            <button
                                ...
                                className="absolute left-6 top-1/2 -translate-y-1/2 p-3 bg-white/10 hover:bg-white/20 text-white rounded-full backdrop-blur-sm transition-all opacity-0 group-hover:opacity-100 disabled:opacity-0 active:scale-95 border border-white/10 z-50 pointer-events-auto"
                            ...
                            <button
                                ...
                                className="absolute right-6 top-1/2 -translate-y-1/2 p-3 bg-white/10 hover:bg-white/20 text-white rounded-full backdrop-blur-sm transition-all opacity-0 group-hover:opacity-100 disabled:opacity-0 active:scale-95 border border-white/10 z-50 pointer-events-auto"
